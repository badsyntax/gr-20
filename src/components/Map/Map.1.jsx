...
//     defaultZoom={9}
//     mapTypeId={'terrain'}
//     defaultCenter={{ lat: 42.184207, lng: 9.107900 }}
//   >
...
//   return (<DefaultMap
//     isMarkerShown
//     googleMapURL="https://maps.googleapis.com/maps/api/js?v=3&libraries=geometry,drawing,places&key=AIzaSyC5hQ9oXMvbJahV2u4bkdIGuflLJtMS2Po"
...
import 'leaflet.elevation/dist/images/elevation.png';
import omnivore from 'leaflet-omnivore';

import gpxData from './gr20.gpx';
...
class Map extends React.Component {
  ...
  componentDidMount() {
    ...
    var runLayer = omnivore.gpx(gpxData)
      .on('ready', function () {
        debugger;
        // console.log('runLayer', el);
        el.addData(runLayer.toGeoJSON(), map)
        // map.fitBounds(runLayer.getBounds());
      });

    // var g = new L.GPX(gpxData, {
  ...
  render() {
    const tileServer1 = 'http://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}'
    const tileServer2 = 'https://maps.tilehosting.com/styles/hybrid/{z}/{x}/{y}.jpg?key=D8rAgJ6CfH56RKjDGVLl';
    const position = [this.state.lat, this.state.lng];
    return (
      <LeafletMap center={position} zoom={this.state.zoom} ref={this.mapRef}>
        <TileLayer
...
// const TheMap = () => (
//   <div style={{ height: '100vh' }}><Map center={position} zoom={13}>
//     <TileLayer
